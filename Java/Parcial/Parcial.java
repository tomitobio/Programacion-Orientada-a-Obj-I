...
// System.out.println("Descuento del " + porcentajeDescuento + "% a " + nombre +
// " realizado. \n");
// }
// }
...
// public Cliente(String nombre, String apellido, String email, int numCliente,
// boolean jubilado) {
...
// }
// System.out.println("El total a pagar es el siguiente: " + "$" +
// p.calcularTotal());
// }
...
// detalles.mostrarDetalles();
// }
// System.out.println("El total a cobrar es el siguiente: " + "$" +
// p.calcularTotal());
...
// public Pedido(ArrayList<Producto> productos, Cliente cliente, Empleado
// empleado) {
...
// Empleado e = new Empleado("Tomas", "Tobio", "tomasetobio@gmail.com",
// "Cajero", "Supermercado");
