...
public class Pedido {
    ...
    public void setCliente(String nombre,String apellido,String email,double numeroCliente,boolean jubilado ){
        this.cliente = new Cliente(nombre,apellido,email,numeroCliente,jubilado);
        this.contador = 0;
    }
    public void setEmpleado(String nombre, String apellido, String email,String puesto , String sector){
